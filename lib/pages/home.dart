...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: InAppWebView(
        initialFile: "assets/Example-leaflet-draw/index.html",
        ...
        onPressed: () async {
          ...
          try {
            ...
            if (constructions != null) {
              ...
              print("constructions not null");

              // Update the jsonData in the Construction object
              constructions!.jsonData = result3;

              // Update the row in the database
              await SQLHelper.instance.writeConstruction(constructions!);
            } else {
              // If constructions is null, create a new Construction object.
              print("constructions null, creating a new object");

              constructions = Construction(jsonData: result3);
              await SQLHelper.instance.createConstruction(constructions!);
            }
